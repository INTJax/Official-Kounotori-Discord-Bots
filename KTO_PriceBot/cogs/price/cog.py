...
class Price(commands.Cog):
    """Keeps track of and updates it's nickname to the KTO price (USD)"""

    #Configure cog logging
    global logger
    logger = logging.getLogger("discord.bot.price")

    def __init__(self, bot: commands.Bot):
        self.bot = bot
        logger.info("price cog initialised")
    
    #Set variables required for price updates
    global OldAmount
    OldAmount = "0"
    global DataSource
    ...
    async def getKTOData():
        ...
        try:
            ...
            logger.error(f"There was an error reading price data! Error was: {e}")
