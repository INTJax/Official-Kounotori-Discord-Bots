    ...
    async def help(self, ctx, command: Option(str, 'Pick a command to learn more about.', required=False, choices=['help','ping','resetconfig','setcolour','setembedchannel','setlogchannel','showconfig'])):
        ...
        match command:
            case None:
                ...
                fields.append({"name": "/setembedchannel", "value": "Set the channel where the \"New KTO Buy\" embed is posted.", "inline": False})
            ...
            case "setembedchannel":
                ...
                fields.append({"name": "Returns", "value": "An embed confirming that the embed channel for new KTO buys has been updated", "inline": False})
                helpembed = await CustomEmbed.newembed(ctx, title="HELP - SETEMBEDCHANNEL", description="Use this command to set the channel for the dynamic embed.", fields=fields)
                embedinvisible = False
            case "setlogchannel":
                fields.append({"name": "Usage", "value": "/setembedchannel channel:(OPTION)", "inline": False})
                fields.append({"name": "Options", "value": "Any text channel in your server", "inline": False})
